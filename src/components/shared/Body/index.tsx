...
const items: MenuItem[] = [
  getItem(
    "default",
    "1",
    <img src={sensor} alt="area" style={{ width: 18, height: 18 }} />,
  ),
  getItem(
    "EP485EWG",
    "2",
    <img src={gateway} alt="machine" style={{ width: 18, height: 18 }} />,
  ),
  getItem(
    "ORC Gateway",
    "3",
    <img src={gateway} alt="device" style={{ width: 18, height: 18 }} />,
  ),
  getItem(
    "Electric Energy",
    "4",
    <img src={sensor} alt="sensor" style={{ width: 18, height: 18 }} />,
  ),
  getItem(
    "Level",
    "5",
  ...
  getItem(
    "OEE Gateway",
    "9",
    <img src={gateway} alt="gateway" style={{ width: 18, height: 18 }} />,
  ),
  getItem(
    "OEE Gateway",
    "10",
  ...
  const columns: TableColumnsType<DataType> = [
    {
      ...
      render: (status) => (
        <div
          className={`size-4 m-auto rounded-full ${status ? "bg-green-500" : "bg-red-500"}`}
        />
      ),
    ...
    <div className="flex flex-1 flex-col bg-white rounded-md min-w-0 min-h-0 overflow-hidden">
      ...
      <div className="flex flex-1 flex-col lg:flex-row min-h-0 overflow-hidden">
        ...
        <div className="w-full lg:w-52 border-b-2 lg:border-b-0 lg:border-r-2 border-[#BBCFEE] bg-gray-50/50 flex flex-col">
          ...
          <div
            className={`pb-2 lg:p-2 flex-1 w-full overflow-y-auto ${styles.thinScrollbar}`}
          >
            <Menu
              theme="light"
        ...
        <div className="flex flex-1 flex-col min-w-0 min-h-0">
          ...
          <div
            className={`flex-1 border-t-2 border-[#BBCFEE] overflow-y-auto min-h-0 ${styles.thinScrollbar}`}
          >
            <ConfigProvider
              theme={{
                components: {
